...
ctld.maxExtractDistance = 1250 -- max distance from vehicle to troops to allow a group extraction
...
ctld.fastRopeMaximumHeight = 180.28 -- in meters which is 60 ft max fast rope (not rappell) safe height
...
ctld.minimumHoverHeight = 1.5 -- Lowest allowable height for crate hover
ctld.maximumHoverHeight = 120.0 -- Highest allowable height for crate hover
ctld.maxDistanceFromCrate = 50.5 -- Maximum distance from from crate for hover
...
ctld.unitActions = {
    ...
    ["AH-64D"] = {crates=true, troops=true},
...
ctld.SOLDIER_WEIGHT = 8 -- kg, will be randomized between 90% and 120%
ctld.KIT_WEIGHT = 2 -- kg
ctld.RIFLE_WEIGHT = 2 -- kg
ctld.MANPAD_WEIGHT = 6 -- kg
ctld.RPG_WEIGHT = 4 -- kg
ctld.MG_WEIGHT = 1 -- kg
ctld.MORTAR_WEIGHT = 6 -- kg
ctld.JTAC_WEIGHT = 1 -- kg
...
ctld.spawnableCrates = {
    ...
    ["Ground Forces"] = {
        ...
        { weight = 50, desc = "HMMWV - TOW", unit = "M1045 HMMWV TOW", side = 2 },
        { weight = 55, desc = "HMMWV - MG", unit = "M1043 HMMWV Armament", side = 2 },

        { weight = 50, desc = "BTR-D", unit = "BTR_D", side = 1 },
        { weight = 55, desc = "BRDM-2", unit = "BRDM-2", side = 1 },

        { weight = 50, desc = "HMMWV - JTAC", unit = "Hummer", side = 2, }, -- used as jtac and unarmed, not on the crate list if JTAC is disabled
        { weight = 55, desc = "SKP-11 - JTAC", unit = "SKP-11", side = 1, }, -- used as jtac and unarmed, not on the crate list if JTAC is disabled

        { weight = 10, desc = "2B11 Mortar", unit = "2B11 mortar" },

        { weight = 20, desc = "SPH 2S19 Msta", unit = "SAU Msta", side = 1, cratesRequired = 3 },
        { weight = 25, desc = "M-109", unit = "M-109", side = 2, cratesRequired = 3 },

        { weight = 22, desc = "Ural-375 Ammo Truck", unit = "Ural-375", side = 1, cratesRequired = 2 },
        { weight = 23, desc = "M-818 Ammo Truck", unit = "M 818", side = 2, cratesRequired = 2 },

        { weight = 80, desc = "FOB Crate - Small", unit = "FOB-SMALL" }, -- Builds a FOB! - requires 3 * ctld.cratesRequiredForFOB
    },
    ["AA short range"] = {
        { weight = 5, desc = "Stinger", unit = "Soldier stinger", side = 2 },
        { weight = 5, desc = "Igla", unit = "SA-18 Igla manpad", side = 1 },

        { weight = 45, desc = "Strela-1 9P31", unit = "Strela-1 9P31", side = 1, cratesRequired = 3 },
        { weight = 40, desc = "M1097 Avenger", unit = "M1097 Avenger", side = 2, cratesRequired = 3 },
    },
    ["AA mid range"] = {
        -- HAWK System
        { weight = 50, desc = "HAWK Launcher", unit = "Hawk ln", side = 2},
        { weight = 55, desc = "HAWK Search Radar", unit = "Hawk sr", side = 2 },
        { weight = 56, desc = "HAWK Track Radar", unit = "Hawk tr", side = 2 },
        { weight = 57, desc = "HAWK PCP", unit = "Hawk pcp" , side = 2 }, -- Remove this if on 1.2
        { weight = 58, desc = "HAWK CWAR", unit = "Hawk cwar" , side = 2 }, -- Remove this if on 2.5
        { weight = 59, desc = "HAWK Repair", unit = "HAWK Repair" , side = 2 },
        -- End of HAWK

        -- KUB SYSTEM
        { weight = 50, desc = "KUB Launcher", unit = "Kub 2P25 ln", side = 1},
        { weight = 55, desc = "KUB Radar", unit = "Kub 1S91 str", side = 1 },
        { weight = 50, desc = "KUB Repair", unit = "KUB Repair", side = 1},
        -- End of KUB
    ...
    ["AA long range"] = {
        -- Patriot System
        { weight = 55, desc = "Patriot Launcher", unit = "Patriot ln", side = 2 },
        { weight = 56, desc = "Patriot Radar", unit = "Patriot str" , side = 2 },
        { weight = 57, desc = "Patriot ECS", unit = "Patriot ECS", side = 2 },
        -- { weight = 553, desc = "Patriot ICC", unit = "Patriot cp", side = 2 },
        -- { weight = 554, desc = "Patriot EPP", unit = "Patriot EPP", side = 2 },
        { weight = 58, desc = "Patriot AMG (optional)", unit = "Patriot AMG" , side = 2 },
        { weight = 59, desc = "Patriot Repair", unit = "Patriot Repair" , side = 2 },
        -- End of Patriot

        { weight = 55, desc = "Early Warning Radar", unit = "1L13 EWR", side = 1 }, -- cant be used by BLUE coalition
    },
}
...
ctld.jtacUnitTypes = {
    "Hummer" -- there are some wierd encoding issues so if you write SKP-11 it wont match as the - sign is encoded differently...
}
